...
enum HordeCategory : uint32_t {
	HCAT_SWARM  = 1u << 0, // sheer numbers of cheap/light bodies
	HCAT_AERIAL = 1u << 1, // flying - vertical threat
	HCAT_HEAVY  = 1u << 2, // armored bruisers - burst-damage check
	HCAT_MELEE  = 1u << 3, // chargers - keep them at range
	HCAT_INFEST = 1u << 4, // wall/ceiling crawlers - ambush
};
