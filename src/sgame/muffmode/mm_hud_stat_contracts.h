...
// STAT_CENTER_LINE        — duel header pic; LMS: primary POV configstring lane
// STAT_WARMUP_NOTICE      — layout slot reserved; warmup guidance uses centerprint (menu-bind band)
// STAT_ROUND_NUMBER       — CONFIG_ROUND_PROGRESS; CA/RR in-progress: secondary POV lane alive "N vs M" (yb below miniscore)
