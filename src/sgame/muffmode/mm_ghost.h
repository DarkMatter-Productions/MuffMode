...
constexpr size_t MM_GHOST_POST_RESTORE_PRESENTATION_ACTIONS_PER_FRAME = 2;
...
constexpr size_t MM_GHOST_MAX_FOLLOW_NAME_CONFIGSTRING_MESSAGE_BYTES =
	MM_GHOST_CONFIGSTRING_MESSAGE_HEADER_BYTES + MAX_NETNAME;
constexpr size_t MM_GHOST_CANONICAL_PRESENTATION_MESSAGES = 2;
constexpr size_t MM_GHOST_MAX_CANONICAL_PRESENTATION_BYTES =
	MM_GHOST_MAX_SKIN_CONFIGSTRING_MESSAGE_BYTES +
	MM_GHOST_MAX_FOLLOW_NAME_CONFIGSTRING_MESSAGE_BYTES;
constexpr size_t MM_GHOST_POST_RESTORE_RELIABLE_MESSAGES_PER_FRAME =
	MM_GHOST_POST_RESTORE_PRESENTATION_ACTIONS_PER_FRAME *
	MM_GHOST_CANONICAL_PRESENTATION_MESSAGES;
constexpr size_t MM_GHOST_POST_RESTORE_RELIABLE_BYTES_PER_FRAME =
	MM_GHOST_POST_RESTORE_PRESENTATION_ACTIONS_PER_FRAME *
