...
FIELD_AUTO(monsterinfo.horde_pursuit_sample_time),
FIELD_AUTO(monsterinfo.horde_pursuit_last_origin),
FIELD_AUTO(monsterinfo.horde_reward_class),
FIELD_AUTO(monsterinfo.horde_strategy),
FIELD_AUTO(monsterinfo.horde_unreach_lo),
FIELD_AUTO(monsterinfo.horde_unreach_hi),
FIELD_AUTO(monsterinfo.horde_unreach_time),
FIELD_AUTO(monsterinfo.horde_reach_sample_time),
