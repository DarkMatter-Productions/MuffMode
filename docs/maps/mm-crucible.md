...
| Field | Details |
| --- | --- |
| Filename | `mm-crucible` |
| Development status | Final release |
| Original map | ztn2dm5 / The Crucible |
| Original author | Sten "ztn" Uusvali |
| Original release date | 6 September 1998 |
| Recommended players | 2-6 |
| Good fits | Duel, FFA, 2v2 |
| Original readme | [ztn2dm5-readme.txt](original-readmes/ztn2dm5-readme.txt) |
| Original BSP | [ztn2dm5.bsp](original-bsps/ztn2dm5.bsp) |
| Remaster source map | [mm-crucible.map](source-maps/mm-crucible.map) |

## Why Play It

A ztn classic with layered control, sharp drops into danger, and enough weapon density to make every route feel contested.
...
| Category | Register |
| --- | --- |
| Spawns | Deathmatch spawn x6, Intermission camera x3, Start point x1 |
| Weapons | Chaingun x1, Grenade Launcher x1, HyperBlaster x1, Railgun x1, Rocket Launcher x2, Super Shotgun x2 |
| Ammo | Bullets x3, Cells x2, Grenades x4, Rockets x3, Shells x3, Slugs x2 |
| Utility | Adrenaline x1, Body Armor x1, Combat Armor x2, Armor Shard x9, Health x5, Large Health x1, Mega Health x1, Small Health x8, Ammo Pack x1 |
...
- Final Muff Mode BSP/source data: [source-maps/mm-crucible.map](source-maps/mm-crucible.map).
