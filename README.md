...
<h2 align="center">Highlights</h2>
 ...
 - **A fuller mode lineup** — includes **Deathmatch**, **Duel**, **TDM**, **CTF**, **Clan Arena**, **Arena Rooms (Rocket Arena)**, **Freeze Tag**, **Capture Strike**, **Red Rover**, **Horde**, **Instagib**, and **NadeFest**.
 ...
 - **Better match flow** — warmups, ready checks, countdowns, post-match delays, sudden death, overtime, round handling, and per-room timeouts help games start cleanly and stay organized.
 - **MuffMode Arena Rooms with RA2 compatibility** — tagged multi-room maps are the native path, while classic RA2 map profiles remain supported. Arena validates each map before activation, then runs independent Rocket Arena, Clan Arena, Red Rover, and Practice rooms through MuffMode's teams, queues, votes, ready-up, competition controls, HUD, and server policies. Ordinary maps never receive synthetic Arena behavior.
